...
builds on ([23 Section 3](../23-go-internals/03-runtime-architecture.md)'s
runtime architecture, [23 Section 2](../23-go-internals/02-ssa-and-optimizations.md)'s
escape mechanics, and [19 Section 2](../19-performance/02-memory-and-allocations.md)'s
...
Section 3](../23-go-internals/03-runtime-architecture.md)) serves small
...
Section 5](../02-go-language/05-pointers-and-receivers.md) covers the
...
with benchmarks ([19 Section 1](../19-performance/01-measure-first.md)).
...
optimization order that works ([19 Section 2](../19-performance/02-memory-and-allocations.md)'s
...
garbage volume rises ([20 Section 2](../20-observability/02-metrics.md)'s
...
Section 2](../19-performance/02-memory-and-allocations.md)'s tuning order:
...
depth at trust boundaries ([21 Section 1](../21-security/01-threat-model-and-validation.md)'s
...
| Tuning GC before fixing allocation volume | Allocation rate dominates GC cost | Reduce allocations first ([19 Section 2](../19-performance/02-memory-and-allocations.md)) |
...
not bytes ([19 Section 2](../19-performance/02-memory-and-allocations.md)).
...
chapter [23 Section 6](../23-go-internals/06-memory-model.md)) matter. The
...
same ([21 Section 4](../21-security/04-limits-and-hardening.md)'s body
...
- `testing.AllocsPerRun` pins the no-allocation contracts of hot
  ...
  Section 2](../23-go-internals/02-ssa-and-optimizations.md)'s example).
